...
public protocol LinkNavigatorType {
    ...
    func next(paths: [String], items: [String: String], isAnimated: Bool, arguments: Any?)
    ...
    ///   - items: A dictionary of `String` type key-value pairs.
    ///   - isAnimated: makes the transition to be animated.
    func rootNext(paths: [String], items: [String: String], isAnimated: Bool, arguments: Any?)
    ...
    ///   - items: A dictionary of `String` type key-value pairs.
    ///   - isAnimated: makes the transition to be animated.
    func sheet(paths: [String], items: [String: String], isAnimated: Bool, arguments: Any?)
    ...
    ///
    func fullSheet(paths: [String], items: [String: String], isAnimated: Bool, prefersLargeTitles: Bool?, arguments: Any?)
    ...
    ///   - items: A dictionary of `String` type key-value pairs.
    ///   - isAnimated: makes the transition to be animated.
    func replace(paths: [String], items: [String: String], isAnimated: Bool, arguments: Any?)
    ...
    ///   - items: A dictionary of `String` type key-value pairs.
    ///   - isAnimated: makes the transition to be animated.
    func backOrNext(path: String, items: [String: String], isAnimated: Bool, arguments: Any?)
    ...
    ///   - items: A dictionary of `String` type key-value pairs.
    ///   - isAnimated: makes the transition to be animated.
    func rootBackOrNext(path: String, items: [String: String], isAnimated: Bool, arguments: Any?)
    ...
    ///   - items: A dictionary of `String` type key-value pairs.
    ///   - isAnimated: makes the transition to be animated.
    func rootReloadLast(items: [String: String], isAnimated: Bool, arguments: Any?)

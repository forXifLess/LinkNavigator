...
public extension LinkNavigator {
    func launch(paths: [String], items: [String: String], prefersLargeTitles: Bool = false) -> BaseNavigator {
        let viewControllers = paths.compactMap { path in
            builders.first(where: { $0.matchPath == path })?.build(self, items, dependency, nil)
        }
...
extension LinkNavigator: LinkNavigatorType {
    ...
    public func next(paths: [String], items: [String: String], isAnimated: Bool, arguments: Any? = nil) {
        let current = currentActivityNavigationController.viewControllers
        let new = paths.compactMap { path in
            builders.first(where: { $0.matchPath == path })?.build(self, items, dependency, arguments)
        }
        currentActivityNavigationController.setViewControllers(current + new, animated: isAnimated)
    }

    public func rootNext(paths: [String], items: [String: String], isAnimated: Bool, arguments: Any? = nil) {
    ...
    public func sheet(paths: [String], items: [String: String], isAnimated: Bool, arguments: Any? = nil) {
    ...
    public func fullSheet(paths: [String], items: [String: String], isAnimated: Bool, prefersLargeTitles: Bool?, arguments: Any? = nil) {
        rootNavigationController.dismiss(animated: true)
    ...
    public func customSheet(
        ...
        prefersLargeTitles: Bool?, arguments: Any? = nil)
    {
        rootNavigationController.dismiss(animated: true)
    ...
    public func replace(paths: [String], items: [String: String], isAnimated: Bool, arguments: Any? = nil) {
    ...
    public func backOrNext(path: String, items: [String: String], isAnimated: Bool, arguments: Any? = nil) {
        ...
        next(paths: [path], items: items, isAnimated: isAnimated, arguments: arguments)
    }

    public func rootBackOrNext(path: String, items: [String: String], isAnimated: Bool, arguments: Any? = nil) {
        ...
        rootNext(paths: [path], items: items, isAnimated: isAnimated, arguments: arguments)
    }
    ...
    public func rootReloadLast(items: [String: String], isAnimated: Bool, arguments: Any?) {
        guard let lastPath = rootCurrentPaths.last else { return }
        guard let new = builders.first(where: { $0.matchPath == lastPath })?.build(self, items, dependency, arguments) else { return }
